...
export const projectConst = [
  ...
  {
    id: 2,
    name: "Order & Reservation System",
    img: p7,
    disc:"An Order and Reservation System built with HTML, Tailwind CSS, JavaScript, PHP, and MySQL for managing bookings and orders.",
