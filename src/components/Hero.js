    ...
    return(
        <section id="home" className=" w-full  my-20 h-auto  flex justify-center items-center overflow-hidden lg:my-4">
            <div className="items-center flex flex-col py-10  justify-center my-25 max-xl:my-15 " >
                ...
                <p className="font-semibold text-xl py-2 px-4 -mt-1 bg-white rounded-4xl drop-shadow-2xl text-cente flex items-center gap-1"><GoDotFill className="text-green-500"/>  Available for Work</p>
                </div>
