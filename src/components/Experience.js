export default function Experience(){
    return(
        <section id="experience" className="w-full ">
            <div className="flex flex-col  py-10 m-2">
                ...
                <div className="flex  flex-col my-20 py-10 items-center text-wrap mx-10">
                    <div className="w-[900px] max-lg:w-auto flex flex-col gap-3.5 border-b py-5 border-secondary-300">
                        ...
                        <p className="text-xl tracking-wide">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lisque persius interesset his et ad mea essent possim iriure.</p>
                    </div>
                    <div className="w-[900px] max-lg:w-auto flex flex-col gap-3.5 border-b py-5 border-secondary-300">
